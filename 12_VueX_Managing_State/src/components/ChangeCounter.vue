<template>
  <div>
    <button @click="addOne">Add 1 using VueX in Vue Method</button> |
    <button @click="addMultiple({ value: 10 })">
      Add 10 using VueX in Vue Method
    </button>
    |
    <button @click="increase({ value: 10 })">
      Add 10 using VueX Mapper Helper
    </button>
  </div>
</template>
